...
#define NSS_BIND_SRV_INPUT_DEPTH                        9    // FFX_NSS_RESOURCE_IDENTIFIER_INPUT_DEPTH

//-----------------------------------------------------------------------------
// Output: UAV bindings
//-----------------------------------------------------------------------------
#define NSS_BIND_UAV_UPSCALED_OUTPUT                    10   // FFX_NSS_RESOURCE_IDENTIFIER_UPSCALED_OUTPUT
#define NSS_BIND_UAV_PREPROCESS_INPUT_TENSOR            11   // rw_preprocessed_tensor (FFX_NSS_RESOURCE_IDENTIFIER_PREPROCESS_INPUT_TENSOR)

#define NSS_BIND_CB_NSS                                 12

#define NSS_BIND_UAV_DEBUG_VIEWS                        13
...
void main()
{
    DebugView(int32_t2(gl_GlobalInvocationID.xy));
}
