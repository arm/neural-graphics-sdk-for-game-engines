...
//-----------------------------------------------------------------------------
// Output: render target binding (fragment path), location 0
//-----------------------------------------------------------------------------
#define NSS_BIND_RENDER_TARGET_DEBUG_VIEWS   0    // FFX_NSS_RESOURCE_IDENTIFIER_DEBUG_VIEWS
...
void main()
{
    DebugViewFS(int32_t2(gl_FragCoord.xy));
}
