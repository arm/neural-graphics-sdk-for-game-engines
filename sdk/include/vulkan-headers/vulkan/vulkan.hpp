...
VULKAN_HPP_INLINE void swap( UniqueHandle<Type, Dispatch> & lhs, UniqueHandle<Type, Dispatch> & rhs ) VULKAN_HPP_NOEXCEPT
{
  ...
  //=== VK_ARM_neural_engine ===
    ...
    VkResult vkCreateNeuralEnginePipelinesARM( VkDevice device, uint32_t createInfoCount, const VkNeuralEnginePipelineCreateInfoARM * pCreateInfos, const VkAllocationCallbacks * pAllocator, VkPipeline * pPipelines ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkCreateNeuralEnginePipelinesARM( device, createInfoCount, pCreateInfos, pAllocator, pPipelines );
    }


    void vkCmdDispatchNeuralEngineARM( VkCommandBuffer commandBuffer, const VkNeuralEngineDispatchInfoARM * pInfo ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkCmdDispatchNeuralEngineARM( commandBuffer, pInfo );
    }


    VkResult vkCreateNeuralEngineWeightsARM( VkDevice device, const VkNeuralEngineWeightsCreateInfoARM * pCreateInfo, const VkAllocationCallbacks * pAllocator, VkNeuralEngineWeightsARM * pNeuralEngineWeights ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkCreateNeuralEngineWeightsARM( device, pCreateInfo, pAllocator, pNeuralEngineWeights );
    }


    void vkDestroyNeuralEngineWeightsARM( VkDevice device, VkNeuralEngineWeightsARM neuralEngineWeights, const VkAllocationCallbacks * pAllocator ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkDestroyNeuralEngineWeightsARM( device, neuralEngineWeights, pAllocator );
    }


    void vkGetNeuralEngineWeightsMemoryRequirementsARM( VkDevice device, const VkNeuralEngineWeightsMemoryRequirementsInfoARM * pInfo, VkMemoryRequirements2 * pMemoryRequirements ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetNeuralEngineWeightsMemoryRequirementsARM( device, pInfo, pMemoryRequirements );
    }


    void vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM( VkDevice device, const VkDeviceNeuralEngineWeightsMemoryRequirementsARM * pInfo, VkMemoryRequirements2 * pMemoryRequirements ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM( device, pInfo, pMemoryRequirements );
    }


    VkResult vkBindNeuralEngineWeightsMemoryARM( VkDevice device, uint32_t bindInfoCount, const VkBindNeuralEngineWeightsMemoryInfoARM * pBindInfos ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkBindNeuralEngineWeightsMemoryARM( device, bindInfoCount, pBindInfos );
    }


    VkDeviceAddress vkGetNeuralEngineWeightsDeviceAddressARM( VkDevice device, const VkNeuralEngineWeightsDeviceAddressInfoARM * pInfo ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetNeuralEngineWeightsDeviceAddressARM( device, pInfo );
    }


    VkDeviceAddress vkGetTensorDeviceAddressARM( VkDevice device, const VkTensorDeviceAddressInfoARM * pInfo ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetTensorDeviceAddressARM( device, pInfo );
    }
  ...
  //=== VK_ARM_data_graph_optical_flow ===
    ...
    VkResult vkGetPhysicalDeviceDataGraphOpticalFlowImageFormatsARM( VkPhysicalDevice physicalDevice, const VkDataGraphOpticalFlowImageFormatInfoARM * pOpticalFlowImageFormatInfo, uint32_t * pFormatCount, VkDataGraphOpticalFlowImageFormatPropertiesARM * pImageFormatProperties ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetPhysicalDeviceDataGraphOpticalFlowImageFormatsARM( physicalDevice, pOpticalFlowImageFormatInfo, pFormatCount, pImageFormatProperties );
    }
...
VULKAN_HPP_CONSTEXPR_INLINE auto EXTNestedCommandBufferSpecVersion = VK_EXT_NESTED_COMMAND_BUFFER_SPEC_VERSION;
  ...
  //=== VK_ARM_neural_engine ===
VULKAN_HPP_CONSTEXPR_INLINE auto ARMNeuralEngineExtensionName = VK_ARM_NEURAL_ENGINE_EXTENSION_NAME;
VULKAN_HPP_CONSTEXPR_INLINE auto ARMNeuralEngineSpecVersion = VK_ARM_NEURAL_ENGINE_SPEC_VERSION;
...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  //=== VK_ARM_neural_engine ===
  template <> struct StructExtends<NeuralEnginePipelineStatisticsDispatchInfoARM, NeuralEngineDispatchInfoARM>{ enum { value = true }; };
  template <> struct StructExtends<WriteDescriptorSetNeuralEngineWeightsARM, WriteDescriptorSet>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceNeuralEngineFeaturesARM, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceNeuralEngineFeaturesARM, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceNeuralEnginePropertiesARM, PhysicalDeviceProperties2>{ enum { value = true }; };
  template <> struct StructExtends<DataGraphPipelineNeuralStatisticsCreateInfoARM, DataGraphPipelineCreateInfoARM>{ enum { value = true }; };
  template <> struct StructExtends<DataGraphPipelineSessionNeuralStatisticsCreateInfoARM, DataGraphPipelineSessionCreateInfoARM>{ enum { value = true }; };
  ...
  template <> struct StructExtends<DataGraphPipelineResourceInfoImageARM, DataGraphPipelineResourceInfoARM>{ enum { value = true }; };
  ...
  template <> struct StructExtends<DataGraphPipelineSingleNodeConnectivityMapARM, DataGraphPipelineOpticalFlowCreateInfoARM>{ enum { value = true }; };
  ...
  //=== VK_ARM_tensor_controls ===
  template <> struct StructExtends<TensorRollingBackingCreateInfoARM, TensorCreateInfoARM>{ enum { value = true }; };
  template <> struct StructExtends<TensorExplicitTilingFormatPropertiesARM, FormatProperties2>{ enum { value = true }; };
  ...
  //=== VK_ARM_data_graph_optical_flow ===
  template <> struct StructExtends<PhysicalDeviceDataGraphOpticalFlowFeaturesARM, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceDataGraphOpticalFlowFeaturesARM, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceDataGraphOpticalFlowPropertiesARM, PhysicalDeviceProperties2>{ enum { value = true }; };
  template <> struct StructExtends<DataGraphPipelineOpticalFlowCreateInfoARM, DataGraphPipelineCreateInfoARM>{ enum { value = true }; };
  template <> struct StructExtends<DataGraphOpticalFlowImageFormatInfoARM, PhysicalDeviceImageFormatInfo2>{ enum { value = true }; };
  template <> struct StructExtends<DataGraphOpticalFlowImageFormatInfoARM, ImageCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<DataGraphPipelineOpticalFlowDispatchInfoARM, DataGraphPipelineDispatchInfoARM>{ enum { value = true }; };
...
#  endif
  ...
  //=== VK_ARM_neural_engine ===
    PFN_vkCreateNeuralEnginePipelinesARM vkCreateNeuralEnginePipelinesARM = 0;
    PFN_vkCmdDispatchNeuralEngineARM vkCmdDispatchNeuralEngineARM = 0;
    PFN_vkCreateNeuralEngineWeightsARM vkCreateNeuralEngineWeightsARM = 0;
    PFN_vkDestroyNeuralEngineWeightsARM vkDestroyNeuralEngineWeightsARM = 0;
    PFN_vkGetNeuralEngineWeightsMemoryRequirementsARM vkGetNeuralEngineWeightsMemoryRequirementsARM = 0;
    PFN_vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM = 0;
    PFN_vkBindNeuralEngineWeightsMemoryARM vkBindNeuralEngineWeightsMemoryARM = 0;
    PFN_vkGetNeuralEngineWeightsDeviceAddressARM vkGetNeuralEngineWeightsDeviceAddressARM = 0;
    PFN_vkGetTensorDeviceAddressARM vkGetTensorDeviceAddressARM = 0;
  ...
  //=== VK_ARM_data_graph_optical_flow ===
    PFN_vkGetPhysicalDeviceDataGraphOpticalFlowImageFormatsARM vkGetPhysicalDeviceDataGraphOpticalFlowImageFormatsARM = 0;
  ...
  //=== VK_ARM_neural_engine ===
      vkCreateNeuralEnginePipelinesARM = PFN_vkCreateNeuralEnginePipelinesARM( vkGetInstanceProcAddr( instance, "vkCreateNeuralEnginePipelinesARM" ) );
      vkCmdDispatchNeuralEngineARM = PFN_vkCmdDispatchNeuralEngineARM( vkGetInstanceProcAddr( instance, "vkCmdDispatchNeuralEngineARM" ) );
      vkCreateNeuralEngineWeightsARM = PFN_vkCreateNeuralEngineWeightsARM( vkGetInstanceProcAddr( instance, "vkCreateNeuralEngineWeightsARM" ) );
      vkDestroyNeuralEngineWeightsARM = PFN_vkDestroyNeuralEngineWeightsARM( vkGetInstanceProcAddr( instance, "vkDestroyNeuralEngineWeightsARM" ) );
      vkGetNeuralEngineWeightsMemoryRequirementsARM = PFN_vkGetNeuralEngineWeightsMemoryRequirementsARM( vkGetInstanceProcAddr( instance, "vkGetNeuralEngineWeightsMemoryRequirementsARM" ) );
      vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM = PFN_vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM( vkGetInstanceProcAddr( instance, "vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM" ) );
      vkBindNeuralEngineWeightsMemoryARM = PFN_vkBindNeuralEngineWeightsMemoryARM( vkGetInstanceProcAddr( instance, "vkBindNeuralEngineWeightsMemoryARM" ) );
      vkGetNeuralEngineWeightsDeviceAddressARM = PFN_vkGetNeuralEngineWeightsDeviceAddressARM( vkGetInstanceProcAddr( instance, "vkGetNeuralEngineWeightsDeviceAddressARM" ) );
      vkGetTensorDeviceAddressARM = PFN_vkGetTensorDeviceAddressARM( vkGetInstanceProcAddr( instance, "vkGetTensorDeviceAddressARM" ) );
  ...
  //=== VK_ARM_data_graph_optical_flow ===
      vkGetPhysicalDeviceDataGraphOpticalFlowImageFormatsARM = PFN_vkGetPhysicalDeviceDataGraphOpticalFlowImageFormatsARM( vkGetInstanceProcAddr( instance, "vkGetPhysicalDeviceDataGraphOpticalFlowImageFormatsARM" ) );
  ...
  //=== VK_ARM_neural_engine ===
      vkCreateNeuralEnginePipelinesARM = PFN_vkCreateNeuralEnginePipelinesARM( vkGetDeviceProcAddr( device, "vkCreateNeuralEnginePipelinesARM" ) );
      vkCmdDispatchNeuralEngineARM = PFN_vkCmdDispatchNeuralEngineARM( vkGetDeviceProcAddr( device, "vkCmdDispatchNeuralEngineARM" ) );
      vkCreateNeuralEngineWeightsARM = PFN_vkCreateNeuralEngineWeightsARM( vkGetDeviceProcAddr( device, "vkCreateNeuralEngineWeightsARM" ) );
      vkDestroyNeuralEngineWeightsARM = PFN_vkDestroyNeuralEngineWeightsARM( vkGetDeviceProcAddr( device, "vkDestroyNeuralEngineWeightsARM" ) );
      vkGetNeuralEngineWeightsMemoryRequirementsARM = PFN_vkGetNeuralEngineWeightsMemoryRequirementsARM( vkGetDeviceProcAddr( device, "vkGetNeuralEngineWeightsMemoryRequirementsARM" ) );
      vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM = PFN_vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM( vkGetDeviceProcAddr( device, "vkGetDeviceNeuralEngineWeightsMemoryRequirementsARM" ) );
      vkBindNeuralEngineWeightsMemoryARM = PFN_vkBindNeuralEngineWeightsMemoryARM( vkGetDeviceProcAddr( device, "vkBindNeuralEngineWeightsMemoryARM" ) );
      vkGetNeuralEngineWeightsDeviceAddressARM = PFN_vkGetNeuralEngineWeightsDeviceAddressARM( vkGetDeviceProcAddr( device, "vkGetNeuralEngineWeightsDeviceAddressARM" ) );
      vkGetTensorDeviceAddressARM = PFN_vkGetTensorDeviceAddressARM( vkGetDeviceProcAddr( device, "vkGetTensorDeviceAddressARM" ) );
