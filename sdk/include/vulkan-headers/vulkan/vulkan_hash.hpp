...
namespace std
{
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::NeuralEngineWeightsARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::NeuralEngineWeightsARM const & neuralEngineWeightsARM) const VULKAN_HPP_NOEXCEPT
    {
      return std::hash<VkNeuralEngineWeightsARM>{}(static_cast<VkNeuralEngineWeightsARM>(neuralEngineWeightsARM));
    }
  };
...
template <> struct hash<VULKAN_HPP_NAMESPACE::AndroidSurfaceCreateInfoKHR>
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::BindDataGraphPipelineSessionMemoryInfoARM const & bindDataGraphPipelineSessionMemoryInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::BindNeuralEngineWeightsMemoryInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::BindNeuralEngineWeightsMemoryInfoARM const & bindNeuralEngineWeightsMemoryInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, bindNeuralEngineWeightsMemoryInfoARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, bindNeuralEngineWeightsMemoryInfoARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, bindNeuralEngineWeightsMemoryInfoARM.neuralEngineWeights );
    VULKAN_HPP_HASH_COMBINE( seed, bindNeuralEngineWeightsMemoryInfoARM.memory );
    VULKAN_HPP_HASH_COMBINE( seed, bindNeuralEngineWeightsMemoryInfoARM.memoryOffset );
      return seed;
    }
  };
...
template <> struct hash<VULKAN_HPP_NAMESPACE::D3D12FenceSubmitInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowImageFormatInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowImageFormatInfoARM const & dataGraphOpticalFlowImageFormatInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DataGraphOpticalFlowImageFormatPropertiesARM>
  {
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphPipelineCompilerControlCreateInfoARM const & dataGraphPipelineCompilerControlCreateInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphPipelineConstantTensorSemiStructuredSparsityInfoARM const & dataGraphPipelineConstantTensorSemiStructuredSparsityInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphPipelineIdentifierCreateInfoARM const & dataGraphPipelineIdentifierCreateInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DataGraphPipelineNeuralStatisticsCreateInfoARM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DataGraphPipelineOpticalFlowCreateInfoARM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DataGraphPipelineOpticalFlowDispatchInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphPipelineOpticalFlowDispatchInfoARM const & dataGraphPipelineOpticalFlowDispatchInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    ...
    VULKAN_HPP_HASH_COMBINE( seed, dataGraphPipelineOpticalFlowDispatchInfoARM.regionCount );
    VULKAN_HPP_HASH_COMBINE( seed, dataGraphPipelineOpticalFlowDispatchInfoARM.pRegions );
      return seed;
    }
  };
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DataGraphPipelineResourceInfoImageARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphPipelineResourceInfoImageARM const & dataGraphPipelineResourceInfoImageARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, dataGraphPipelineResourceInfoImageARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, dataGraphPipelineResourceInfoImageARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, dataGraphPipelineResourceInfoImageARM.layout );
      return seed;
    }
  };
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphPipelineSessionBindPointRequirementARM const & dataGraphPipelineSessionBindPointRequirementARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphPipelineSessionBindPointRequirementsInfoARM const & dataGraphPipelineSessionBindPointRequirementsInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DataGraphPipelineSessionNeuralStatisticsCreateInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphPipelineSessionNeuralStatisticsCreateInfoARM const & dataGraphPipelineSessionNeuralStatisticsCreateInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DataGraphPipelineSingleNodeConnectionARM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::DataGraphPipelineSingleNodeConnectivityMapARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphPipelineSingleNodeConnectivityMapARM const & dataGraphPipelineSingleNodeConnectivityMapARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, dataGraphPipelineSingleNodeConnectivityMapARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, dataGraphPipelineSingleNodeConnectivityMapARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, dataGraphPipelineSingleNodeConnectivityMapARM.connectionCount );
    VULKAN_HPP_HASH_COMBINE( seed, dataGraphPipelineSingleNodeConnectivityMapARM.pConnections );
      return seed;
    }
  };
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDataGraphProcessingEngineARM const & physicalDeviceDataGraphProcessingEngineARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DataGraphProcessingEngineCreateInfoARM const & dataGraphProcessingEngineCreateInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::NeuralEngineWeightsCreateInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::NeuralEngineWeightsCreateInfoARM const & neuralEngineWeightsCreateInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.flags );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream0Size0 );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream0Size1 );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream0Size2 );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream0Size3 );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream1Size0 );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream1Size1 );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream1Size2 );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream1Size3 );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream0DataSize );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsCreateInfoARM.stream1DataSize );
      return seed;
    }
  };

  template <> struct hash<VULKAN_HPP_NAMESPACE::DeviceNeuralEngineWeightsMemoryRequirementsARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::DeviceNeuralEngineWeightsMemoryRequirementsARM const & deviceNeuralEngineWeightsMemoryRequirementsARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, deviceNeuralEngineWeightsMemoryRequirementsARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, deviceNeuralEngineWeightsMemoryRequirementsARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, deviceNeuralEngineWeightsMemoryRequirementsARM.pCreateInfo );
      return seed;
    }
  };
...
template <> struct hash<VULKAN_HPP_NAMESPACE::ExportSemaphoreWin32HandleInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::Extent4DARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::Extent4DARM const & extent4DARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, extent4DARM.x );
    VULKAN_HPP_HASH_COMBINE( seed, extent4DARM.y );
    VULKAN_HPP_HASH_COMBINE( seed, extent4DARM.z );
    VULKAN_HPP_HASH_COMBINE( seed, extent4DARM.w );
      return seed;
    }
  };
...
template <> struct hash<VULKAN_HPP_NAMESPACE::MetalSurfaceCreateInfoEXT>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::Offset4DARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::Offset4DARM const & offset4DARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, offset4DARM.x );
    VULKAN_HPP_HASH_COMBINE( seed, offset4DARM.y );
    VULKAN_HPP_HASH_COMBINE( seed, offset4DARM.z );
    VULKAN_HPP_HASH_COMBINE( seed, offset4DARM.w );
      return seed;
    }
  };

  template <> struct hash<VULKAN_HPP_NAMESPACE::NeuralEngineDispatchInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::NeuralEngineDispatchInfoARM const & neuralEngineDispatchInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.offset );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.size );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.iteratorOuterDimension );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.iteratorInnerDimension );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.taskIncrementOuter );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.taskIncrementInner );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.iteratorWeightArrayOffset );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.iteratorWeightArrayBehavior );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.iteratorTraceID0 );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineDispatchInfoARM.iteratorTraceID1 );
      return seed;
    }
  };

  template <> struct hash<VULKAN_HPP_NAMESPACE::NeuralEnginePipelineCreateInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::NeuralEnginePipelineCreateInfoARM const & neuralEnginePipelineCreateInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineCreateInfoARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineCreateInfoARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineCreateInfoARM.flags );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineCreateInfoARM.layout );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineCreateInfoARM.neuralEngineDescriptorSize );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineCreateInfoARM.pNeuralEngineDescriptor );
      return seed;
    }
  };

  template <> struct hash<VULKAN_HPP_NAMESPACE::NeuralEnginePipelineStatisticsDispatchInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::NeuralEnginePipelineStatisticsDispatchInfoARM const & neuralEnginePipelineStatisticsDispatchInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineStatisticsDispatchInfoARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineStatisticsDispatchInfoARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineStatisticsDispatchInfoARM.mode );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineStatisticsDispatchInfoARM.memory );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEnginePipelineStatisticsDispatchInfoARM.memoryOffset );
      return seed;
    }
  };

  template <> struct hash<VULKAN_HPP_NAMESPACE::NeuralEngineWeightsDeviceAddressInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::NeuralEngineWeightsDeviceAddressInfoARM const & neuralEngineWeightsDeviceAddressInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsDeviceAddressInfoARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsDeviceAddressInfoARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsDeviceAddressInfoARM.neuralEngineWeights );
      return seed;
    }
  };

  template <> struct hash<VULKAN_HPP_NAMESPACE::NeuralEngineWeightsMemoryRequirementsInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::NeuralEngineWeightsMemoryRequirementsInfoARM const & neuralEngineWeightsMemoryRequirementsInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsMemoryRequirementsInfoARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsMemoryRequirementsInfoARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, neuralEngineWeightsMemoryRequirementsInfoARM.neuralEngineWeights );
      return seed;
    }
  };
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceCudaKernelLaunchPropertiesNV>
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDataGraphOperationSupportARM const & physicalDeviceDataGraphOperationSupportARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDataGraphOpticalFlowFeaturesARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDataGraphOpticalFlowFeaturesARM const & physicalDeviceDataGraphOpticalFlowFeaturesARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDataGraphOpticalFlowPropertiesARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceDataGraphOpticalFlowPropertiesARM const & physicalDeviceDataGraphOpticalFlowPropertiesARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.supportedOutputGridSizes );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.supportedHintGridSizes );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.hintSupported );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.costSupported );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.bidirectionalFlowSupported );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.globalFlowSupported );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.minWidth );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.minHeight );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.maxWidth );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.maxHeight );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceDataGraphOpticalFlowPropertiesARM.maxNumRegionsOfInterest );
      return seed;
    }
  };
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalMemoryScreenBufferFeaturesQNX>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceNeuralEngineFeaturesARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceNeuralEngineFeaturesARM const & physicalDeviceNeuralEngineFeaturesARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceNeuralEngineFeaturesARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceNeuralEngineFeaturesARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceNeuralEngineFeaturesARM.neuralEngine );
      return seed;
    }
  };

  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceNeuralEnginePropertiesARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceNeuralEnginePropertiesARM const & physicalDeviceNeuralEnginePropertiesARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceNeuralEnginePropertiesARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceNeuralEnginePropertiesARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDeviceNeuralEnginePropertiesARM.neuralEngineCount );
      return seed;
    }
  };
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePresentMeteringFeaturesNV>
  ...
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceQueueFamilyDataGraphProcessingEngineInfoARM const & physicalDeviceQueueFamilyDataGraphProcessingEngineInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::SurfaceFullScreenExclusiveWin32InfoEXT>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::TensorDeviceAddressInfoARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::TensorDeviceAddressInfoARM const & tensorDeviceAddressInfoARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, tensorDeviceAddressInfoARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, tensorDeviceAddressInfoARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, tensorDeviceAddressInfoARM.tensor );
      return seed;
    }
  };

  template <> struct hash<VULKAN_HPP_NAMESPACE::TensorExplicitTilingFormatPropertiesARM>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::TensorRollingBackingCreateInfoARM>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::Win32SurfaceCreateInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::WriteDescriptorSetNeuralEngineWeightsARM>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::WriteDescriptorSetNeuralEngineWeightsARM const & writeDescriptorSetNeuralEngineWeightsARM) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, writeDescriptorSetNeuralEngineWeightsARM.sType );
    VULKAN_HPP_HASH_COMBINE( seed, writeDescriptorSetNeuralEngineWeightsARM.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, writeDescriptorSetNeuralEngineWeightsARM.neuralEngineWeightsCount );
    VULKAN_HPP_HASH_COMBINE( seed, writeDescriptorSetNeuralEngineWeightsARM.pNeuralEngineWeights );
      return seed;
    }
  };
