...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  VULKAN_HPP_INLINE std::string to_string( ImageUsageFlags value )
  {
    ...
    if ( value & ImageUsageFlagBits::eDataGraphARM ) result += " DataGraphARM |";
  ...
  VULKAN_HPP_INLINE std::string to_string( QueueFlags value )
  {
    ...
    if ( value & QueueFlagBits::eNeuralEngineARM ) result += " NeuralEngineARM |";
  ...
  VULKAN_HPP_INLINE std::string to_string( PipelineStageFlags2 value )
  {
    ...
    if ( value & PipelineStageFlagBits2::eNeuralEngineARM ) result += " NeuralEngineARM |";
  ...
  VULKAN_HPP_INLINE std::string to_string( AccessFlags2 value )
  {
    ...
    if ( value & AccessFlagBits2::eNeuralEngineReadARM ) result += " NeuralEngineReadARM |";
    if ( value & AccessFlagBits2::eNeuralEngineWriteARM ) result += " NeuralEngineWriteARM |";
  ...
  VULKAN_HPP_INLINE std::string to_string( FormatFeatureFlags2 value )
  {
    ...
    if ( value & FormatFeatureFlagBits2::eTensorNeuralEngineARM ) result += " TensorNeuralEngineARM |";
    ...
    if ( value & FormatFeatureFlagBits2::eDataGraphOpticalFlowImageARM ) result += " DataGraphOpticalFlowImageARM |";
    if ( value & FormatFeatureFlagBits2::eDataGraphOpticalFlowVectorARM ) result += " DataGraphOpticalFlowVectorARM |";
    if ( value & FormatFeatureFlagBits2::eDataGraphOpticalFlowCostARM ) result += " DataGraphOpticalFlowCostARM |";
  ...
  VULKAN_HPP_INLINE std::string to_string( BufferUsageFlags2 value )
  {
    ...
    if ( value & BufferUsageFlagBits2::eDataGraphForeignDescriptorARM ) result += " DataGraphForeignDescriptorARM |";
  ...
  VULKAN_HPP_INLINE std::string to_string( NeuralEngineWeightsCreateFlagsARM value )
  {
    std::string result = "{";
    if ( value & NeuralEngineWeightsCreateFlagBitsARM::eProtected ) result += " Protected |";
  ...
  VULKAN_HPP_INLINE std::string to_string( TensorUsageFlagsARM value )
  {
    ...
    if ( value & TensorUsageFlagBitsARM::eNeuralEngine ) result += " NeuralEngine |";
    if ( value & TensorUsageFlagBitsARM::eDeviceAddress ) result += " DeviceAddress |";
  ...
  VULKAN_HPP_INLINE std::string to_string( DataGraphOpticalFlowUsageFlagsARM value )
  {
    std::string result = "{";
    if ( value & DataGraphOpticalFlowUsageFlagBitsARM::eInput ) result += " Input |";
    if ( value & DataGraphOpticalFlowUsageFlagBitsARM::eOutput ) result += " Output |";
    if ( value & DataGraphOpticalFlowUsageFlagBitsARM::eHint ) result += " Hint |";
    if ( value & DataGraphOpticalFlowUsageFlagBitsARM::eCost ) result += " Cost |";
    if ( value & DataGraphOpticalFlowUsageFlagBitsARM::eGlobalFlow ) result += " GlobalFlow |";
  ...
  {
    std::string result = "{";
    if ( value & DataGraphOpticalFlowCreateFlagBitsARM::eEnableHint ) result += " EnableHint |";
    if ( value & DataGraphOpticalFlowCreateFlagBitsARM::eEnableCost ) result += " EnableCost |";
    if ( value & DataGraphOpticalFlowCreateFlagBitsARM::eEnableGlobalFlow ) result += " EnableGlobalFlow |";
    if ( value & DataGraphOpticalFlowCreateFlagBitsARM::eAllowRegions ) result += " AllowRegions |";
    if ( value & DataGraphOpticalFlowCreateFlagBitsARM::eBothDirections ) result += " BothDirections |";
  ...
  {
    std::string result = "{";
    if ( value & DataGraphOpticalFlowGridSizeFlagBitsARM::e1X1 ) result += " 1X1 |";
    if ( value & DataGraphOpticalFlowGridSizeFlagBitsARM::e2X2 ) result += " 2X2 |";
    if ( value & DataGraphOpticalFlowGridSizeFlagBitsARM::e4X4 ) result += " 4X4 |";
    if ( value & DataGraphOpticalFlowGridSizeFlagBitsARM::e8X8 ) result += " 8X8 |";
  ...
  {
    std::string result = "{";
    if ( value & DataGraphOpticalFlowExecuteFlagBitsARM::eDisableTemporalHints ) result += " DisableTemporalHints |";
    if ( value & DataGraphOpticalFlowExecuteFlagBitsARM::eInputUnchanged ) result += " InputUnchanged |";
    if ( value & DataGraphOpticalFlowExecuteFlagBitsARM::eReferenceUnchanged ) result += " ReferenceUnchanged |";
    if ( value & DataGraphOpticalFlowExecuteFlagBitsARM::eInputReferenceUnchanged ) result += " InputReferenceUnchanged |";
    if ( value & DataGraphOpticalFlowExecuteFlagBitsARM::eReferenceInputUnchanged ) result += " ReferenceInputUnchanged |";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( StructureType value )
  {
    switch ( value )
    {
      ...
      case StructureType::eNeuralEnginePipelineCreateInfoARM : return "NeuralEnginePipelineCreateInfoARM";
      case StructureType::eNeuralEngineWeightsCreateInfoARM : return "NeuralEngineWeightsCreateInfoARM";
      case StructureType::eWriteDescriptorSetNeuralEngineWeightsARM : return "WriteDescriptorSetNeuralEngineWeightsARM";
      case StructureType::eNeuralEngineWeightsDeviceAddressInfoARM : return "NeuralEngineWeightsDeviceAddressInfoARM";
      case StructureType::eTensorDeviceAddressInfoARM : return "TensorDeviceAddressInfoARM";
      case StructureType::eNeuralEnginePipelineStatisticsDispatchInfoARM : return "NeuralEnginePipelineStatisticsDispatchInfoARM";
      case StructureType::ePhysicalDeviceNeuralEnginePropertiesARM : return "PhysicalDeviceNeuralEnginePropertiesARM";
      case StructureType::ePhysicalDeviceNeuralEngineFeaturesARM : return "PhysicalDeviceNeuralEngineFeaturesARM";
      case StructureType::eBindNeuralEngineWeightsMemoryInfoARM : return "BindNeuralEngineWeightsMemoryInfoARM";
      case StructureType::eNeuralEngineWeightsMemoryRequirementsInfoARM : return "NeuralEngineWeightsMemoryRequirementsInfoARM";
      case StructureType::eDeviceNeuralEngineWeightsMemoryRequirementsARM : return "DeviceNeuralEngineWeightsMemoryRequirementsARM";
      case StructureType::eNeuralEngineDispatchInfoARM : return "NeuralEngineDispatchInfoARM";
      ...
      case StructureType::eDataGraphPipelineResourceInfoImageARM : return "DataGraphPipelineResourceInfoImageARM";
      case StructureType::eDataGraphPipelineSingleNodeConnectivityMapARM : return "DataGraphPipelineSingleNodeConnectivityMapARM";
      ...
      case StructureType::ePhysicalDeviceDataGraphOpticalFlowPropertiesARM : return "PhysicalDeviceDataGraphOpticalFlowPropertiesARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( ObjectType value )
  {
    switch ( value )
    {
      ...
      case ObjectType::eNeuralEngineWeightsARM : return "NeuralEngineWeightsARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( Format value )
  {
    switch ( value )
    {
      ...
      case Format::eSbs80ARM : return "Sbs80ARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( ImageUsageFlagBits value )
  {
    switch ( value )
    {
      ...
      case ImageUsageFlagBits::eDataGraphARM : return "DataGraphARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( QueueFlagBits value )
  {
    switch ( value )
    {
      ...
      case QueueFlagBits::eNeuralEngineARM : return "NeuralEngineARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( DescriptorType value )
  {
    switch ( value )
    {
      ...
      case DescriptorType::eNeuralEngineWeightsARM : return "NeuralEngineWeightsARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( PipelineBindPoint value )
  {
    switch ( value )
    {
      ...
      case PipelineBindPoint::eNeuralEngineARM : return "NeuralEngineARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( PipelineStageFlagBits2 value )
  {
    switch ( value )
    {
      ...
      case PipelineStageFlagBits2::eNeuralEngineARM : return "NeuralEngineARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( AccessFlagBits2 value )
  {
    switch ( value )
    {
      ...
      case AccessFlagBits2::eNeuralEngineReadARM : return "NeuralEngineReadARM";
      case AccessFlagBits2::eNeuralEngineWriteARM : return "NeuralEngineWriteARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( FormatFeatureFlagBits2 value )
  {
    switch ( value )
    {
      ...
      case FormatFeatureFlagBits2::eTensorNeuralEngineARM : return "TensorNeuralEngineARM";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( NeuralEnginePipelineStatisticsModeARM value )
  {
    switch ( value )
    {
      case NeuralEnginePipelineStatisticsModeARM::eDisabled : return "Disabled";
      case NeuralEnginePipelineStatisticsModeARM::eStatistics0 : return "Statistics0";
      case NeuralEnginePipelineStatisticsModeARM::eStatistics1 : return "Statistics1";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( NeuralEngineWeightsCreateFlagBitsARM value )
  {
    switch ( value )
    {
      case NeuralEngineWeightsCreateFlagBitsARM::eProtected : return "Protected";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( TensorUsageFlagBitsARM value )
  {
    switch ( value )
    {
      ...
      case TensorUsageFlagBitsARM::eNeuralEngine : return "NeuralEngine";
      case TensorUsageFlagBitsARM::eDeviceAddress : return "DeviceAddress";
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( DataGraphPipelineSessionBindPointARM value )
  {
    switch ( value )
    {
      ...
      case DataGraphPipelineSessionBindPointARM::eNeuralStatistics : return "NeuralStatistics";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( DataGraphPipelinePropertyARM value )
  {
    switch ( value )
    {
      ...
      case DataGraphPipelinePropertyARM::eNeuralEngineDebugDatabase : return "NeuralEngineDebugDatabase";
      case DataGraphPipelinePropertyARM::eNeuralEngineStatisticsInfo : return "NeuralEngineStatisticsInfo";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( DataGraphOpticalFlowUsageFlagBitsARM value )
  {
    switch ( value )
    {
      case DataGraphOpticalFlowUsageFlagBitsARM::eUnknown : return "Unknown";
      case DataGraphOpticalFlowUsageFlagBitsARM::eInput : return "Input";
      case DataGraphOpticalFlowUsageFlagBitsARM::eOutput : return "Output";
      case DataGraphOpticalFlowUsageFlagBitsARM::eHint : return "Hint";
      case DataGraphOpticalFlowUsageFlagBitsARM::eCost : return "Cost";
      case DataGraphOpticalFlowUsageFlagBitsARM::eGlobalFlow : return "GlobalFlow";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( DataGraphOpticalFlowCreateFlagBitsARM value )
  {
    switch ( value )
    {
      ...
      case DataGraphOpticalFlowCreateFlagBitsARM::eEnableGlobalFlow : return "EnableGlobalFlow";
      case DataGraphOpticalFlowCreateFlagBitsARM::eAllowRegions : return "AllowRegions";
      case DataGraphOpticalFlowCreateFlagBitsARM::eBothDirections : return "BothDirections";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( DataGraphOpticalFlowConnectionARM value )
  {
    switch ( value )
    {
      case DataGraphOpticalFlowConnectionARM::eUnknown : return "Unknown";
      case DataGraphOpticalFlowConnectionARM::eInput : return "Input";
      case DataGraphOpticalFlowConnectionARM::eReference : return "Reference";
      case DataGraphOpticalFlowConnectionARM::eHint : return "Hint";
      case DataGraphOpticalFlowConnectionARM::eFlowVector : return "FlowVector";
      case DataGraphOpticalFlowConnectionARM::eBackwardFlowVector : return "BackwardFlowVector";
      case DataGraphOpticalFlowConnectionARM::eCost : return "Cost";
      case DataGraphOpticalFlowConnectionARM::eBackwardCost : return "BackwardCost";
      case DataGraphOpticalFlowConnectionARM::eGlobalFlow : return "GlobalFlow";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR_20 std::string to_string( DataGraphOpticalFlowExecuteFlagBitsARM value )
  {
    switch ( value )
    {
      ...
      case DataGraphOpticalFlowExecuteFlagBitsARM::eInputReferenceUnchanged : return "InputReferenceUnchanged";
      case DataGraphOpticalFlowExecuteFlagBitsARM::eReferenceInputUnchanged : return "ReferenceInputUnchanged";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
