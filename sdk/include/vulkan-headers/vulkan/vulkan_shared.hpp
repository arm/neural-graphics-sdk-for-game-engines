...
#  pragma clang diagnostic pop
  ...
  template <>
  class SharedHandleTraits<NeuralEngineWeightsARM>
  {
  public:
    using DestructorType = Device;
    using deleter = detail::ObjectDestroyShared<NeuralEngineWeightsARM>;
  };
  using SharedNeuralEngineWeightsARM = SharedHandle<NeuralEngineWeightsARM>;
