...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  enum class StructureType{
    ...
    eNeuralEnginePipelineCreateInfoARM = VK_STRUCTURE_TYPE_NEURAL_ENGINE_PIPELINE_CREATE_INFO_ARM,
    eNeuralEngineWeightsCreateInfoARM = VK_STRUCTURE_TYPE_NEURAL_ENGINE_WEIGHTS_CREATE_INFO_ARM,
    eWriteDescriptorSetNeuralEngineWeightsARM = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_NEURAL_ENGINE_WEIGHTS_ARM,
    eNeuralEngineWeightsDeviceAddressInfoARM = VK_STRUCTURE_TYPE_NEURAL_ENGINE_WEIGHTS_DEVICE_ADDRESS_INFO_ARM,
    eTensorDeviceAddressInfoARM = VK_STRUCTURE_TYPE_TENSOR_DEVICE_ADDRESS_INFO_ARM,
    eNeuralEnginePipelineStatisticsDispatchInfoARM = VK_STRUCTURE_TYPE_NEURAL_ENGINE_PIPELINE_STATISTICS_DISPATCH_INFO_ARM,
    ePhysicalDeviceNeuralEnginePropertiesARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NEURAL_ENGINE_PROPERTIES_ARM,
    ePhysicalDeviceNeuralEngineFeaturesARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NEURAL_ENGINE_FEATURES_ARM,
    eBindNeuralEngineWeightsMemoryInfoARM = VK_STRUCTURE_TYPE_BIND_NEURAL_ENGINE_WEIGHTS_MEMORY_INFO_ARM,
    eNeuralEngineWeightsMemoryRequirementsInfoARM = VK_STRUCTURE_TYPE_NEURAL_ENGINE_WEIGHTS_MEMORY_REQUIREMENTS_INFO_ARM,
    eDeviceNeuralEngineWeightsMemoryRequirementsARM = VK_STRUCTURE_TYPE_DEVICE_NEURAL_ENGINE_WEIGHTS_MEMORY_REQUIREMENTS_ARM,
    eNeuralEngineDispatchInfoARM = VK_STRUCTURE_TYPE_NEURAL_ENGINE_DISPATCH_INFO_ARM,
    ...
    eDataGraphPipelineResourceInfoImageARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_RESOURCE_INFO_IMAGE_ARM,
    eDataGraphPipelineSingleNodeConnectivityMapARM = VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SINGLE_NODE_CONNECTIVITY_MAP_ARM,
    ...
    ePhysicalDeviceDataGraphOpticalFlowPropertiesARM = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DATA_GRAPH_OPTICAL_FLOW_PROPERTIES_ARM,
  ...
  enum class ObjectType{
    ...
    eNeuralEngineWeightsARM = VK_OBJECT_TYPE_NEURAL_ENGINE_WEIGHTS_ARM,
  ...
  enum class ImageUsageFlagBits : VkImageUsageFlags{
    ...
    eDataGraphARM = VK_IMAGE_USAGE_DATA_GRAPH_BIT_ARM,
  ...
  template <> struct FlagTraits<ImageUsageFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR ImageUsageFlags allFlags = 
        ...
        | ImageUsageFlagBits::eDataGraphARM
  ...
  enum class QueueFlagBits : VkQueueFlags{
    ...
    eNeuralEngineARM = VK_QUEUE_NEURAL_ENGINE_BIT_ARM,
  ...
  template <> struct FlagTraits<QueueFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR QueueFlags allFlags = 
        ...
        | QueueFlagBits::eNeuralEngineARM
...
;
  ...
  enum class DescriptorType{
    ...
    eNeuralEngineWeightsARM = VK_DESCRIPTOR_TYPE_NEURAL_ENGINE_WEIGHTS_ARM,
  ...
  enum class PipelineBindPoint{
    ...
    eNeuralEngineARM = VK_PIPELINE_BIND_POINT_NEURAL_ENGINE_ARM,
...
;
  ...
  enum class PipelineStageFlagBits2 : VkPipelineStageFlags2{
    ...
    eNeuralEngineARM = VK_PIPELINE_STAGE_2_NEURAL_ENGINE_BIT_ARM,
  ...
  template <> struct FlagTraits<PipelineStageFlagBits2>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineStageFlags2 allFlags = 
        ...
        | PipelineStageFlagBits2::eNeuralEngineARM
  ...
  enum class AccessFlagBits2 : VkAccessFlags2{
    ...
    eNeuralEngineReadARM = VK_ACCESS_2_NEURAL_ENGINE_READ_BIT_ARM,
    eNeuralEngineWriteARM = VK_ACCESS_2_NEURAL_ENGINE_WRITE_BIT_ARM,
  ...
  template <> struct FlagTraits<AccessFlagBits2>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR AccessFlags2 allFlags = 
        ...
        | AccessFlagBits2::eNeuralEngineReadARM
        | AccessFlagBits2::eNeuralEngineWriteARM
  ...
  enum class FormatFeatureFlagBits2 : VkFormatFeatureFlags2{
    ...
    eTensorNeuralEngineARM = VK_FORMAT_FEATURE_2_TENSOR_NEURAL_ENGINE_BIT_ARM,
  ...
  template <> struct FlagTraits<FormatFeatureFlagBits2>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR FormatFeatureFlags2 allFlags = 
        ...
        | FormatFeatureFlagBits2::eTensorNeuralEngineARM
  ...
  // wrapper class for enum VkNeuralEnginePipelineStatisticsModeARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkNeuralEnginePipelineStatisticsModeARM.html
  enum class NeuralEnginePipelineStatisticsModeARM{
    eDisabled = VK_NEURAL_ENGINE_PIPELINE_STATISTICS_MODE_DISABLED_ARM,
    eStatistics0 = VK_NEURAL_ENGINE_PIPELINE_STATISTICS_MODE_STATISTICS0_ARM,
    eStatistics1 = VK_NEURAL_ENGINE_PIPELINE_STATISTICS_MODE_STATISTICS1_ARM
  };
  
  
  
  // wrapper class for enum VkNeuralEngineWeightsCreateFlagBitsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkNeuralEngineWeightsCreateFlagBitsARM.html
  enum class NeuralEngineWeightsCreateFlagBitsARM : VkNeuralEngineWeightsCreateFlagsARM{
    eProtected = VK_NEURAL_ENGINE_WEIGHTS_CREATE_PROTECTED_BIT_ARM
  };
  
  
  
  // wrapper using for bitmask VkNeuralEngineWeightsCreateFlagsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkNeuralEngineWeightsCreateFlagsARM.html
  using NeuralEngineWeightsCreateFlagsARM = Flags<NeuralEngineWeightsCreateFlagBitsARM>;


  template <> struct FlagTraits<NeuralEngineWeightsCreateFlagBitsARM>
  {
    using WrappedType = VkNeuralEngineWeightsCreateFlagBitsARM;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR NeuralEngineWeightsCreateFlagsARM allFlags = 
          NeuralEngineWeightsCreateFlagBitsARM::eProtected;
  };
  ...
  enum class TensorUsageFlagBitsARM : VkTensorUsageFlagsARM{
    ...
    eNeuralEngine = VK_TENSOR_USAGE_NEURAL_ENGINE_BIT_ARM,
    eDeviceAddress = VK_TENSOR_USAGE_DEVICE_ADDRESS_BIT_ARM,
  ...
  template <> struct FlagTraits<TensorUsageFlagBitsARM>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR TensorUsageFlagsARM allFlags = 
        ...
        | TensorUsageFlagBitsARM::eNeuralEngine
        | TensorUsageFlagBitsARM::eDeviceAddress
  ...
  enum class DataGraphPipelineSessionBindPointARM{
    ...
    eNeuralStatistics = VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_NEURAL_STATISTICS_ARM
  };
  ...
  enum class DataGraphPipelinePropertyARM{
    ...
    eNeuralEngineDebugDatabase = VK_DATA_GRAPH_PIPELINE_PROPERTY_NEURAL_ENGINE_DEBUG_DATABASE_ARM,
    eNeuralEngineStatisticsInfo = VK_DATA_GRAPH_PIPELINE_PROPERTY_NEURAL_ENGINE_STATISTICS_INFO_ARM
  };
  ...
  // wrapper class for enum VkDataGraphOpticalFlowUsageFlagBitsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowUsageFlagBitsARM.html
  enum class DataGraphOpticalFlowUsageFlagBitsARM : VkDataGraphOpticalFlowUsageFlagsARM{
    eUnknown = VK_DATA_GRAPH_OPTICAL_FLOW_USAGE_UNKNOWN_ARM,
    eInput = VK_DATA_GRAPH_OPTICAL_FLOW_USAGE_INPUT_BIT_ARM,
    eOutput = VK_DATA_GRAPH_OPTICAL_FLOW_USAGE_OUTPUT_BIT_ARM,
    eHint = VK_DATA_GRAPH_OPTICAL_FLOW_USAGE_HINT_BIT_ARM,
    eCost = VK_DATA_GRAPH_OPTICAL_FLOW_USAGE_COST_BIT_ARM,
    eGlobalFlow = VK_DATA_GRAPH_OPTICAL_FLOW_USAGE_GLOBAL_FLOW_BIT_ARM
  };
  
  
  
  // wrapper using for bitmask VkDataGraphOpticalFlowUsageFlagsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowUsageFlagsARM.html
  using DataGraphOpticalFlowUsageFlagsARM = Flags<DataGraphOpticalFlowUsageFlagBitsARM>;


  template <> struct FlagTraits<DataGraphOpticalFlowUsageFlagBitsARM>
  {
    using WrappedType = VkDataGraphOpticalFlowUsageFlagBitsARM;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR DataGraphOpticalFlowUsageFlagsARM allFlags = 
          DataGraphOpticalFlowUsageFlagBitsARM::eUnknown
        | DataGraphOpticalFlowUsageFlagBitsARM::eInput
        | DataGraphOpticalFlowUsageFlagBitsARM::eOutput
        | DataGraphOpticalFlowUsageFlagBitsARM::eHint
        | DataGraphOpticalFlowUsageFlagBitsARM::eCost
        | DataGraphOpticalFlowUsageFlagBitsARM::eGlobalFlow;
  };

  // wrapper class for enum VkDataGraphOpticalFlowCreateFlagBitsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowCreateFlagBitsARM.html
  enum class DataGraphOpticalFlowCreateFlagBitsARM : VkDataGraphOpticalFlowCreateFlagsARM{
    ...
    eEnableGlobalFlow = VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ENABLE_GLOBAL_FLOW_BIT_ARM,
    eAllowRegions = VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ALLOW_REGIONS_BIT_ARM,
    eBothDirections = VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_BOTH_DIRECTIONS_BIT_ARM
  };
  
  
  
  // wrapper using for bitmask VkDataGraphOpticalFlowCreateFlagsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowCreateFlagsARM.html
  using DataGraphOpticalFlowCreateFlagsARM = Flags<DataGraphOpticalFlowCreateFlagBitsARM>;


  template <> struct FlagTraits<DataGraphOpticalFlowCreateFlagBitsARM>
  {
    using WrappedType = VkDataGraphOpticalFlowCreateFlagBitsARM;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR DataGraphOpticalFlowCreateFlagsARM allFlags = 
          DataGraphOpticalFlowCreateFlagBitsARM::eEnableHint
        | DataGraphOpticalFlowCreateFlagBitsARM::eEnableCost
        | DataGraphOpticalFlowCreateFlagBitsARM::eEnableGlobalFlow
        | DataGraphOpticalFlowCreateFlagBitsARM::eAllowRegions
        | DataGraphOpticalFlowCreateFlagBitsARM::eBothDirections;
  };

  // wrapper class for enum VkDataGraphOpticalFlowPerformanceLevelARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowPerformanceLevelARM.html
  ...
  // wrapper class for enum VkDataGraphOpticalFlowGridSizeFlagBitsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowGridSizeFlagBitsARM.html
  ...
  // wrapper using for bitmask VkDataGraphOpticalFlowGridSizeFlagsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowGridSizeFlagsARM.html
  using DataGraphOpticalFlowGridSizeFlagsARM = Flags<DataGraphOpticalFlowGridSizeFlagBitsARM>;


  template <> struct FlagTraits<DataGraphOpticalFlowGridSizeFlagBitsARM>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR DataGraphOpticalFlowGridSizeFlagsARM allFlags = 
          DataGraphOpticalFlowGridSizeFlagBitsARM::eUnknown
  ...
  // wrapper class for enum VkDataGraphOpticalFlowConnectionARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowConnectionARM.html
  enum class DataGraphOpticalFlowConnectionARM{
    eUnknown = VK_DATA_GRAPH_OPTICAL_FLOW_CONNECTION_UNKNOWN_ARM,
    eInput = VK_DATA_GRAPH_OPTICAL_FLOW_CONNECTION_INPUT_ARM,
    eReference = VK_DATA_GRAPH_OPTICAL_FLOW_CONNECTION_REFERENCE_ARM,
    eHint = VK_DATA_GRAPH_OPTICAL_FLOW_CONNECTION_HINT_ARM,
    eFlowVector = VK_DATA_GRAPH_OPTICAL_FLOW_CONNECTION_FLOW_VECTOR_ARM,
    eBackwardFlowVector = VK_DATA_GRAPH_OPTICAL_FLOW_CONNECTION_BACKWARD_FLOW_VECTOR_ARM,
    eCost = VK_DATA_GRAPH_OPTICAL_FLOW_CONNECTION_COST_ARM,
    eBackwardCost = VK_DATA_GRAPH_OPTICAL_FLOW_CONNECTION_BACKWARD_COST_ARM,
    eGlobalFlow = VK_DATA_GRAPH_OPTICAL_FLOW_CONNECTION_GLOBAL_FLOW_ARM
  };
  
  
  
  // wrapper class for enum VkDataGraphOpticalFlowExecuteFlagBitsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowExecuteFlagBitsARM.html
  enum class DataGraphOpticalFlowExecuteFlagBitsARM : VkDataGraphOpticalFlowExecuteFlagsARM{
    ...
    eInputReferenceUnchanged = VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_INPUT_REFERENCE_UNCHANGED_BIT_ARM,
    eReferenceInputUnchanged = VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_REFERENCE_INPUT_UNCHANGED_BIT_ARM
  };
  
  
  
  // wrapper using for bitmask VkDataGraphOpticalFlowExecuteFlagsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowExecuteFlagsARM.html
  using DataGraphOpticalFlowExecuteFlagsARM = Flags<DataGraphOpticalFlowExecuteFlagBitsARM>;


  template <> struct FlagTraits<DataGraphOpticalFlowExecuteFlagBitsARM>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR DataGraphOpticalFlowExecuteFlagsARM allFlags = 
          DataGraphOpticalFlowExecuteFlagBitsARM::eDisableTemporalHints
        | DataGraphOpticalFlowExecuteFlagBitsARM::eInputUnchanged
        | DataGraphOpticalFlowExecuteFlagBitsARM::eReferenceUnchanged
        | DataGraphOpticalFlowExecuteFlagBitsARM::eInputReferenceUnchanged
        | DataGraphOpticalFlowExecuteFlagBitsARM::eReferenceInputUnchanged;
  };
  ...
  //=== VK_ARM_neural_engine ===
      case VULKAN_HPP_NAMESPACE::ObjectType::eNeuralEngineWeightsARM : return VULKAN_HPP_NAMESPACE::DebugReportObjectTypeEXT::eUnknown;
  ...
  //=== VK_ARM_data_graph ===
      case VULKAN_HPP_NAMESPACE::ObjectType::eDataGraphPipelineSessionARM : return VULKAN_HPP_NAMESPACE::DebugReportObjectTypeEXT::eUnknown;
