#[[
 Copyright (c) 2019-2023,2025-2026 Arm Limited and Contributors
...
function(android_sync_folder)
    set(options)
    set(oneValueArgs PATH DEST_REL)
    set(multiValueArgs)
    ...
    set(SYNC_COMMAND ${CMAKE_COMMAND}
            ...
            -DDEVICE_DIR=/sdcard/Android/data/com.khronos.${PROJECT_NAME}/files/${TARGET_DEST_REL}/
